...
describe CrashDataController do
  ...
  describe "GET index" do
    xit "assigns all crash_data as @crash_data" do
  ...
  describe "GET show" do
    xit "assigns the requested crash_data as @crash_data" do
      crash_data = CrashData.create! valid_attributes
  ...
  describe "GET new" do
    xit "assigns a new crash_data as @crash_data" do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      xit "assigns a newly created but unsaved crash_data as @crash_data" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      xit "updates the requested crash_data" do
        crash_data = CrashData.create! valid_attributes
      ...
      xit "redirects to the crash_data" do
        crash_data = CrashData.create! valid_attributes
        put :update, {:id => crash_data.to_param, :crash_data => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      xit "assigns the crash_data as @crash_data" do
        crash_data = CrashData.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        CrashData.any_instance.stub(:save).and_return(false)
  ...
  describe "DELETE destroy" do
    xit "destroys the requested crash_data" do
      crash_data = CrashData.create! valid_attributes
      expect {
    ...
    xit "redirects to the crash_data list" do
      crash_data = CrashData.create! valid_attributes
      delete :destroy, {:id => crash_data.to_param}, valid_session
